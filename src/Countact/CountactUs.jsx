...
const CountactUs = () => {
    ...
    return (
        ...
        <div className="mb-3">
          ...
          <input type="email" name='email' placeholder='Email Addres' className="form-control" required   />
        </div>
        <div className="mb-3">
        ...
        <div className="mb-3">
         ...
         <button id='btn' onClick={massge} type='submit'>Submit Form</button>
      </form>
      </div>
